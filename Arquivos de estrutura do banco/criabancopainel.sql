...
CREATE TABLE macnicolas_has_lednicolas (
...
PRIMARY KEY(macnicolas_idmacnicolas, lednicolas_idlednicolas)  ,
INDEX macnicolas_has_lednicolas_FKIndex1(macnicolas_idmacnicolas)  ,
INDEX macnicolas_has_lednicolas_FKIndex2(lednicolas_idlednicolas)  ,
INDEX macnicolas_has_lednicolas_FKIndex3(painelnicolas_idpainelnicolas),
